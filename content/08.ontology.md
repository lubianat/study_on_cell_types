...
\subsection{ontoProc: Ontology interfaces for Bioconductor, with focus on cell type identification}
...
\subsection{Cells in ExperimentaL Life Sciences (CELLS-2018): capturing the knowledge of normal and diseased cells with ontologies}
...
\subsection{Reporting and connecting cell type names and gating definitions through ontologies}
    \cite{overton2019reporting}
