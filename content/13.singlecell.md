...
\section{Single-celll RNA-Seq annotations}
\subsection{Searching large-scale scRNA-seq databases via unbiased cell embedding with Cell BLAST}
...
\subsection{Probabilistic gene expression signatures identify cell-types from single cell RNA-seq data}
...
\subsection{R Package: Single-cell RNAseq cell cluster labelling by reference}
